...
The dependencies declared by A are usually class and interfaces, and B provides the concrete implementations for those interfaces declared in A as dependencies of B. 
